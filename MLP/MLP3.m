...
% Archivos para guardar y cargar pesos y conteo de ejecuciones
    ...
    pesos3_file = "./polinomio2/pesos3.txt";
...
% Archivos para guardar y cargar pesos y conteo de ejecuciones
    ejecuciones_file = "./polinomio4/ejecuciones.txt";
    pesos1_file = "./polinomio4/pesos1.txt";
    pesos2_file = "./polinomio4/pesos2.txt";
    pesos3_file = "./polinomio4/pesos3.txt";
